...
#[cfg(feature = "num-bigint")]
impl<M: ManagedTypeApi> From<&dharitri_codec::num_bigint::BigUint> for BigUint<M> {
    fn from(alloc_big_uint: &dharitri_codec::num_bigint::BigUint) -> Self {
...
impl<M: ManagedTypeApi> BigUint<M> {
    pub fn to_alloc(&self) -> dharitri_codec::num_bigint::BigUint {
        dharitri_codec::num_bigint::BigUint::from_bytes_be(self.to_bytes_be().as_slice())
    }
}
